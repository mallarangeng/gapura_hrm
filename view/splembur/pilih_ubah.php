...
<div class="form-group">
    ...
    <label>Pilih Nama Karyawan</label>
      <input type="hidden" name="id" value="<?php echo $dk['id']; ?>" class="form-control">
      <input type="hidden" name="id_spl" value="<?php echo $dk['id_spl']; ?>" class="form-control">
      <select name="nik" class="selectpicker" data-show-subtext="true" data-live-search="true">
    <option data-subtext="<?php echo $dk['nik']; ?>" value="<?php echo $dk['nik']; ?>"><?php echo $dk['nama']; ?> / <?php echo $d['nm_jabatan']; ?></option>
      <?php
    ...
    ?>
      ...
      <div class="col-sm-6">
      <input type="text" name="ket" value="<?php echo $dk['ket']; ?>" class="form-control">
      <!--
